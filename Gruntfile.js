var js_arr = ['wui/js/wui_form.js', 'wui/js/wui_dialog.js', 'wui/js/wui_dropdown.js', 'wui/js/wui_range_slider.js', 'wui/js/wui_tabs.js', 'wui/js/wui_toolbar.js', 'wui/js/wui_circular_menu.js', 'wui/js/wui.js'];
...
module.exports = function(grunt) {
    grunt.initConfig({
     ...
     concat: {
       dist: {
         files: {
          'dist/wui.js': js_arr,
           'dist/dark/wui.css': ['wui/css/themes/dark/wui_form.css','wui/css/themes/dark/wui_dialog.css', 'wui/css/themes/dark/wui_dropdown.css', 'wui/css/themes/dark/wui_range_slider.css', 'wui/css/themes/dark/wui_tabs.css', 'wui/css/themes/dark/wui_toolbar.css', 'wui/css/themes/dark/wui_circular_menu.css', 'wui/css/wui.css'],
           'dist/bright/wui.css': ['wui/css/themes/bright/wui_form.css', 'wui/css/themes/bright/wui_dialog.css', 'wui/css/themes/bright/wui_dropdown.css', 'wui/css/themes/bright/wui_range_slider.css', 'wui/css/themes/bright/wui_tabs.css', 'wui/css/themes/bright/wui_toolbar.css', 'wui/css/themes/bright/wui_circular_menu.css', 'wui/css/wui.css']
         }
       }
     },
      ...
      uglify: {
        ...
        target: {
          files: {
              'dist/wui.min.js': ['wui/js/wui_form.js', 'wui/js/wui_dialog.js', 'wui/js/wui_dropdown.js', 'wui/js/wui_range_slider.js', 'wui/js/wui_tabs.js', 'wui/js/wui_toolbar.js', 'wui/js/wui_circular_menu.js', 'wui/js/wui.js'],

              'dist/widgets/WUI.min.js':                                ['wui/js/wui.js'],
              'dist/widgets/WUI_Form/wui_form.min.js':                  ['wui/js/wui_form.js'],
    ...
    cssmin: {
        ...
        target: {
        files: {
            'dist/dark/wui.min.css': ['wui/css/themes/dark/wui_form.css', 'wui/css/themes/dark/wui_dialog.css', 'wui/css/themes/dark/wui_dropdown.css', 'wui/css/themes/dark/wui_range_slider.css', 'wui/css/themes/dark/wui_tabs.css', 'wui/css/themes/dark/wui_toolbar.css', 'wui/css/themes/dark/wui_circular_menu.css', 'wui/css/wui.css'],
            'dist/bright/wui.min.css': ['wui/css/themes/bright/wui_form.css', 'wui/css/themes/bright/wui_dialog.css', 'wui/css/themes/bright/wui_dropdown.css', 'wui/css/themes/bright/wui_range_slider.css', 'wui/css/themes/bright/wui_tabs.css', 'wui/css/themes/bright/wui_toolbar.css', 'wui/css/themes/bright/wui_circular_menu.css', 'wui/css/wui.css'],

                    'dist/widgets/WUI.min.css':                                     ['wui/css/wui.css'],
              'dist/widgets/WUI_Form/dark/wui_form.min.css':                  ['wui/css/themes/dark/wui_form.css'],
              ...
              'dist/widgets/WUI_ToolBar/dark/wui_toolbar.min.css':            ['wui/css/themes/dark/wui_toolbar.css'],
                   ...
                   'dist/widgets/WUI.min.css':                                ['wui/css/wui.css'],
              'dist/widgets/WUI_Form/bright/wui_form.min.css':                  ['wui/css/themes/bright/wui_form.css'],
    ...
    compress: {
      ...
      target: {
        files: [
          ...
          {expand: true, src: ['dist/widgets/WUI_Form/dark/wui_form.min.css'],                  dest: '', ext: '.gz.css'},
          ...
          {expand: true, src: ['dist/widgets/WUI_CircularMenu/dark/wui_circular_menu.min.css'], dest: '', ext: '.gz.css'},
                    ...
                    {expand: true, src: ['dist/widgets/WUI.min.css'],                                dest: '', ext: '.gz.css'},
          {expand: true, src: ['dist/widgets/WUI_Form/bright/wui_form.min.css'],                  dest: '', ext: '.gz.css'},
          ...
          {expand: true, src: ['dist/widgets/WUI_Form/wui_form.min.js'],                  dest: '', ext: '.gz.js'},
